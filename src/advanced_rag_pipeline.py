...
>>>>>>> 68d87b6cf762d8835195c0bb5ce2208fab967936
            응답 형식 (JSON):
            {{
                "is_valid": true/false,
...
3. 그 다음에 '답변 :'을 쓰고, 정책을 번호를 매겨서 정리한다.
   - 최소 1개, 최대 3개까지만 가장 핵심적인 정책을 골라 설명한다.
   - 각 정책은 아래 구조를 따른다.
...
"""
    ...
    (
        ...
        """
<<<<<<< HEAD
다음 답변을 사용자가 빠르게 이해할 수 있도록 핵심만 요약해줘.

...
class AdvancedRAGPipeline:
    ...
    def __init__(
        ...
        1. 주거·월세 지원
            ...
            [신청 방법]
            어디에 신청 : (예: 시·군청 청년정책 담당부서, 온라인 신청 등)
        ...
        - 대시(-) 특수기호 사용 금지
        - 정책 추천에 대해서만 사용자 입력과 정책 내용을 비교해 서로 직접 연결되는 조건이나 경험만 근거로, 이 사용자에게 이 정책을 추천한 이유를 사용자가 얻게 되는 구체적인 이득 중심 문장으로 작성. 
        - 정책 추천에 대해서만 짧은 문단으로 작성. 
        - 정책 추천에 대해서만 일반적인 정책 설명은 금지.
